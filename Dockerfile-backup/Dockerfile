...
#
#    docker build -t stanleyu/quantopian-zipline .
#
#
#
...
#
# Add the jupyter initialization script to image 
# and execute the scrip tto create the 
# secret keys for jupyter https service
#
