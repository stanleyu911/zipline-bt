...
# if not, grab a copy of the 'stanleyu/zipline' docker image from my docker https://hub.docker.com/
docker pull stanleyu/zipline
...
docker run --rm -p:8888:8888/tcp --name zipline -v /Volumes/media/GitHub/zipline-bt/Clenow:/projects -v /Volumes/media/GitHub/zipline-bt/.zipline:/root/.zipline -it stanleyu/zipline

# Folder /Volumes/media/GitHub/zipline-bt/.zipline is a copy of
# the zipline eod data folder created by 'zipline ingest quandl' command  
...
stanleyu/dashboard              v1.0      99ad26d5da94   16 hours ago    1.41GB
stanleyu/dashboard-base-image   latest    56ab752d2f59   16 hours ago    1.37GB
quantopian/zipline              latest    514d65931106   17 hours ago    2.39GB
...
Not have Pyfolio which is essential module is required by Clenow's python code

Hence I created my own zipline image, they are named Quantopian/zipline. It uses zipline code base 
